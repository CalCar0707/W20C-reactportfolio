...
export default function Contact() {
    return (
        <div name='contact' className="w-full h-screen bg-[#f7f7f7] flex justify-center items-center p-4 pl-[100px]">
            <form method="POST" action="https://getform.io/f/cba3d8f0-bee2-4310-b0ab-fb901d98d12b" className="flex flex-col max-w-[600px] w-full">
                <div className='pb-8'>
                    <p className='text-5xl sm:text-6xl font-bold inline pb-[8px] border-b-4 border-[#0a192f]'>Contact</p>
